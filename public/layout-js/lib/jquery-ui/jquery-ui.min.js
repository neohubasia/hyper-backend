          ...
          return (
            ...
            this.each(function () {
              var s,
                ...
                S = d + y + i(this, "marginBottom") + w.height,
                N = e.extend({}, b),
                M = t(T.my, u.outerWidth(), u.outerHeight());
              "right" === n.my[0]
                ? (N.left -= c)
                : "center" === n.my[0] && (N.left -= c / 2),
                "bottom" === n.my[1]
                  ? (N.top -= d)
                  : "center" === n.my[1] && (N.top -= d / 2),
                (N.left += M[0]),
                (N.top += M[1]),
          ...
          flip: {
            left: function (e, t) {
              var i,
                ...
                f = -2 * t.offset[0];
              0 > u
                ? ((i = e.left + d + p + f + t.collisionWidth - o - a),
                  (0 > i || r(u) > i) && (e.left += d + p + f))
                : c > 0 &&
                  ((s =
                    e.left - t.collisionPosition.marginLeft + d + p + f - h),
            ...
            !e.contains(
              ...
              ? (s.snapElements[d].snapping &&
                  ...
                  s.options.snap.release.call(
                    s.element,
                    t,
                    e.extend(s._uiHash(), { snapItem: s.snapElements[d].item })
                  ),
      ...
      _refreshItems: function (t) {
        ...
        if (d && this.ready)
          for (i = d.length - 1; i >= 0; i--)
            for (n = e(d[i], this.document[0]), s = n.length - 1; s >= 0; s--)
  ...
  (e.effects = { effect: {} }),
                ...
                ? (n instanceof l
                    ...
                    : f(u, function (t, s) {
                        ...
                        f(s.props, function (e, t) {
                          ...
                          c[a] &&
                            0 > e.inArray(null, c[a].slice(0, 3)) &&
        ...
        function (t, i) {
          e.fx.step[i] = function (e) {
            (("none" !== e.end && !e.setAttr) || (1 === e.pos && !e.setAttr)) &&
              (r.style(e.elem, i, e.end), (e.setAttr = !0));
          };
        }
      ),
        e.fn.addBack ||
    ...
    (e.effects.effect.explode = function (t, i) {
      ...
      var a,
        ...
        y = [];
      for (a = 0; c > a; a++)
        for (h = g.top + a * b, u = a - (c - 1) / 2, o = 0; d > o; o++)
          (r = g.left + o * v),
            (l = o - (d - 1) / 2),
            p
              .clone()
    ...
    (e.effects.effect.size = function (t, i) {
      ...
      "show" === p && o.show(),
        ...
        ("box" === m || "both" === m) &&
          (a.from.y !== a.to.y &&
            ((b = b.concat(c)),
            (o.from = e.effects.setTransition(o, c, a.from.y, o.from)),
            (o.to = e.effects.setTransition(o, c, a.to.y, o.to))),
          a.from.x !== a.to.x &&
            ((b = b.concat(d)),
            (o.from = e.effects.setTransition(o, d, a.from.x, o.from)),
            (o.to = e.effects.setTransition(o, d, a.to.x, o.to)))),
        ("content" === m || "both" === m) &&
          a.from.y !== a.to.y &&
        ...
        ("content" === m || "both" === m) &&
          ...
          o.find("*[width]").each(function () {
            ...
            f && e.effects.save(i, l),
              ...
              a.from.y !== a.to.y &&
                ((i.from = e.effects.setTransition(i, c, a.from.y, i.from)),
                (i.to = e.effects.setTransition(i, c, a.to.y, i.to))),
              a.from.x !== a.to.x &&
                ((i.from = e.effects.setTransition(i, d, a.from.x, i.from)),
                (i.to = e.effects.setTransition(i, d, a.to.x, i.to))),
              i.css(i.from),
    ...
    (e.effects.effect.pulsate = function (t, i) {
      ...
      for (
        ...
        n.animate({ opacity: c }, u, t.easing), (c = 1 - c);
