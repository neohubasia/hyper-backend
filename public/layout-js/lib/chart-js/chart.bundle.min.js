...
!(function (t, e) {
  ...
  function ve(t, e, i, n) {
        ...
        if (void 0 === e || void 0 === i) {
          ...
          if (s) {
            ...
            (e = t.width - l.width - r.width),
              ...
              (n = ge(a.maxWidth, s, "clientWidth")),
              (o = ge(a.maxHeight, s, "clientHeight"));
    ...
    return (
      ...
      (c = ye(Math.min(c, a, l.maxWidth))),
      (h = ye(Math.min(h, r, l.maxHeight))),
      c && !h && (h = ye(c / 2)),
      { width: c, height: h }
    );
  }
  ...
  function Se(t, e) {
    return "native" in t ? { x: t.x, y: t.y } : _e(t, e);
  }
  function Pe(t, e, i, n) {
  ...
  function Oe(t, e, i, n, o) {
    ...
    return (
      De(t, i, e, function (i, l, c) {
        if (n && !i.inRange(e.x, e.y, o)) return;
        const h = i.getCenterPoint(o);
        if (!Gt(h, t.chartArea, t._minPadding) && !i.inRange(e.x, e.y, o))
          return;
        const d = s(e, h);
        d < a
  ...
  function Ue(t, e) {
    const i = (function (t) {
        const e = {};
        for (const i of t) {
          const { stack: t, pos: n, stackWeight: o } = i;
    ...
    for (s = 0, a = t.length; s < a; ++s) {
      ...
      r.horizontal
        ? ((r.width = c ? c * n : a && e.availableWidth), (r.height = o))
        : ((r.width = n), (r.height = c ? c * o : a && e.availableHeight));
    }
    return i;
  }
  function Xe(t, e, i, n) {
  ...
  function Ze(t, e, i, n) {
    ...
    for (s = 0, a = t.length, c = 0; s < a; ++s) {
      (r = t[s]),
        (l = r.box),
        l.update(r.width || e.w, r.height || e.h, Ge(r.horizontal, e));
      const { same: a, other: d } = Ke(e, i, r, n);
  ...
  function Je(t, e, i, n) {
    ...
    for (const r of t) {
      ...
      if (r.horizontal) {
        const n = e.w * c,
          s = l.size || t.height;
        ht(l.start) && (a = l.start),
          t.fullSize
            ? Qe(t, o.left, a, i.outerWidth - o.right - o.left, s)
            : Qe(t, e.left + l.placed, a, n, s),
          (l.start = a),
          (l.placed += n),
          (a = t.bottom);
      } else {
        const n = e.h * c,
          a = l.size || t.width;
        ht(l.start) && (s = l.start),
          t.fullSize
            ? Qe(t, s, o.top, a, i.outerHeight - o.bottom - o.top)
            : Qe(t, s, e.top + l.placed, a, n),
          (l.start = s),
          (l.placed += n),
          (s = t.right);
      }
  ...
  var ti = {
    ...
    update(t, e, i, n) {
      ...
      Ze(r.fullSize, f, d, g),
        ...
        Je(r.leftAndTop, f, d, g),
        (f.x += f.w),
        (f.y += f.h),
        Je(r.rightAndBottom, f, d, g),
        (t.chartArea = {
          left: f.left,
          top: f.top,
          right: f.left + f.w,
      ...
      get: (i, n) =>
        ai(i, n, () =>
          (function (t, e, i, n) {
            let o;
            for (const s of e)
              if (((o = ui(oi(s, t), i)), ht(o)))
                return si(t, o) ? hi(i, n, t, o) : o;
          })(n, e, t, i)
        ),
  ...
  function yi(t, e, i, n, o) {
    ...
    if (
      ...
      for (s = 0, a = t.length; s < a; ++s)
        (r = t[s]),
          (l = xi(i, r, t[Math.min(s + 1, a - (n ? 0 : 1)) % a], e.tension)),
          (r.cp1x = l.previous.x),
          (r.cp1y = l.previous.y),
          (r.cp2x = l.next.x),
          (r.cp2y = l.next.y),
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a &&
                ((o.cp1x = _i(o.cp1x, e.left, e.right)),
                (o.cp1y = _i(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = _i(o.cp2x, e.left, e.right)),
                (o.cp2y = _i(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  const vi = (t) => 0 === t || 1 === t,
    wi = (t, e, i) =>
    ...
    ki = {
      ...
      easeInElastic: (t) => (vi(t) ? t : wi(t, 0.075, 0.3)),
      easeOutElastic: (t) => (vi(t) ? t : Mi(t, 0.075, 0.3)),
      easeInOutElastic(t) {
        const e = 0.1125;
        return vi(t)
          ? t
      ...
      easeInOutBounce: (t) =>
        t < 0.5
          ? 0.5 * ki.easeInBounce(2 * t)
          : 0.5 * ki.easeOutBounce(2 * t - 1) + 0.5,
    };
  function Si(t, e, i, n) {
  ...
  function Ei({ start: t, end: e, count: i, loop: n, style: o }) {
    return {
      start: t % i,
      end: e % i,
      loop: n && (e - t + 1) % i == 0,
  ...
  function Fi(t, e) {
    ...
    if (!0 === n) return Bi(t, [{ start: a, end: r, loop: s }], i, e);
    return Bi(
      t,
      (function (t, e, i, n) {
        const o = t.length,
          ...
          for (const c of e) {
            ...
            for (l = r + 1; l <= c.end; l++) {
              ...
              (e = Vi(
                ...
                Wi(e, h) &&
                  (a.push({ start: r, end: l - 1, loop: c.loop, style: h }),
                  (h = e),
                  (r = l - 1)),
                (d = o),
                (h = e);
            ...
            r < l - 1 &&
              (a.push({ start: r, end: l - 1, loop: c.loop, style: e }),
              (r = l - 1));
          }
          return a;
        })(t, e, i, n)
  ...
  class nn extends Hi {
    ...
    removeEventListener(t, e) {
      const i = t.$proxies || (t.$proxies = {}),
        n = i[e];
      if (!n) return;
      (({ attach: tn, detach: tn, resize: tn }[e] || Xi)(t, e, n),
        (i[e] = void 0));
    }
    getDevicePixelRatio() {
  ...
  class ln {
    constructor(t, e, i, n) {
      ...
      (this._active = !0),
        (this._fn = t.fn || rn[t.type || typeof s]),
    ...
    update(t, e, i) {
      ...
      if (n._active) {
        ...
        (n._start = i),
          ...
          (n._total += s),
          (n._loop = !!t.loop),
          (n._to = We([t.to, e, o, t.from])),
          (n._from = We([t.from, o, e]));
      }
    }
    cancel() {
      const t = this;
  ...
  function xn(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      const i = e[t],
        { [l]: n, [c]: s } = i;
      (u = (i._stacks || (i._stacks = {}))[c] = pn(o, h, n)),
        (u[r] = s),
        (u._top = mn(u, a, !0)),
        (u._bottom = mn(u, a, !1));
    }
  ...
  class wn {
    ...
    _dataCheck() {
      ...
      if (U(i))
        ...
        i && Object.isExtensible(i) && ce(i, t),
          (t._syncList = []),
          (t._data = i);
      }
    }
    ...
    buildOrUpdateElements(t) {
      ...
      e._dataCheck();
      const s = i._stacked;
      (i._stacked = gn(i.vScale, i)),
        i.stack !== n.stack && ((o = !0), _n(i), (i.stack = n.stack)),
        e._resyncElements(t),
        (o || s !== i._stacked) && xn(e, i._parsed);
    }
    configure() {
      const t = this,
        e = t.chart.config,
    ...
    applyStack(t, e, i) {
      const n = this.chart,
        o = this._cachedMeta,
        s = e[t.axis];
      return fn({ keys: un(n, !0), values: e._stacks[t.axis] }, s, o.index, {
        mode: i,
      });
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      n &&
        ...
        (s = fn(n, o, this._cachedMeta.index, { all: !0 }))),
        (t.min = Math.min(t.min, s)),
        (t.max = Math.max(t.max, s));
    }
    getMinMax(t, e) {
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        g.$shared && ((g.$shared = l), (s[a] = Object.freeze(vn(g, l)))), g
      );
    }
  ...
  (wn.defaults = {}),
    (wn.prototype.datasetElementType = null),
    (wn.prototype.dataElementType = null);
  class Mn {
    constructor() {
      (this.x = void 0),
        (this.y = void 0),
  ...
  const kn = {
    ...
    logarithmic(t, e, i) {
      ...
      return 1 === n || 2 === n || 5 === n
        ? kn.numeric.call(this, t, e, i)
        : "";
    },
  };
  var Sn = { formatters: kn };
  function Pn(t, e) {
    ...
    if (s > 0) {
      ...
      for (Dn(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++)
        Dn(e, l, c, o[t], o[t + 1]);
  ...
  class En extends Mn {
    ...
    update(t, e, i) {
      ...
      n.beforeUpdate(),
        ...
        n._dataLimitsCached ||
          ...
          n.afterDataLimits(),
          (n._range = Ne(n, n.options.grace)),
          (n._dataLimitsCached = !0)),
        n.beforeBuildTicks(),
        (n.ticks = n.buildTicks() || []),
        n.afterBuildTicks();
      const a = s < n.ticks.length;
      n._convertTicksToLabels(a ? On(n.ticks, s) : n.ticks),
        n.configure(),
        ...
        o.display &&
          ...
          ((n.ticks = Pn(n, n.ticks)), (n._labelSizes = null)),
      ...
      (a = e.offset ? t.maxWidth / n : f / (n - 1)),
        d + 6 > a &&
          ...
          (r =
            ...
            An(e.grid) -
            i.padding -
            Ln(e.title, t.chart.options.font)),
          (l = Math.sqrt(d * d + u * u)),
          (c = It(
            Math.min(
              Math.asin(Ht((h.highest.height + 6) / a, -1, 1)),
              Math.asin(Ht(r / l, -1, 1)) - Math.asin(Ht(u / l, -1, 1))
            )
          )),
    ...
    fit() {
      ...
      if (a) {
        ...
        if (
          (r
            ? ((e.width = t.maxWidth), (e.height = An(s) + a))
            : ((e.height = t.maxHeight), (e.width = An(s) + a)),
              ...
              (C =
                "top" === o
                  ? "near" === c || 0 !== p
                    ? -D * P + P / 2
                    : "center" === c
                    ? -T.highest.height / 2 - i * P + P
                    : -T.highest.height + P / 2
                  : "near" === c || 0 !== p
                  ? P / 2
                  : "center" === c
                  ? T.highest.height / 2 - i * P
                  : T.highest.height - D * P),
              d && (C *= -1))
            : ((w = k), (C = ((1 - D) * P) / 2)),
          t.showLabelBackdrop)
        ) {
    ...
    drawTitle() {
      ...
      const {
        ...
        const { top: s, left: a, bottom: r, right: l, chart: c } = t,
        ...
        if (t.isHorizontal()) {
          if (((f = o(n, a, l)), U(i))) {
            ...
            g = "center" === i ? (h.bottom + h.top) / 2 + m - e : Cn(t, i, e);
          u = l - a;
        } else {
          if (U(i)) {
            const t = Object.keys(i)[0],
            ...
            f = "center" === i ? (h.left + h.right) / 2 - x + e : Cn(t, i, e);
  ...
  var zn = new (class {
    constructor() {
      (this.controllers = new In(wn, "datasets", !0)),
        (this.elements = new In(Mn, "elements")),
        (this.plugins = new In(Object, "plugins")),
        (this.scales = new In(En, "scales")),
        ...
        ? (function (t, e, i, n) {
            ...
            for (let a = 0; a < e.length; a++) {
              const r = e[a],
                l = Bn(i[r.id], n);
              null !== l &&
                o.push({ plugin: r, options: Vn(t.config, r, l, s) });
            }
            return o;
          })(t, o, n, e)
        : [];
  ...
  class qn {
    ...
    getOptionScopes(t, e, i) {
      ...
      const r = new Set();
      e.forEach((e) => {
        t && (r.add(t), e.forEach((e) => Xn(r, t, e))),
          e.forEach((t) => Xn(r, n, t)),
          e.forEach((t) => Xn(r, ft[o] || {}, t)),
          e.forEach((t) => Xn(r, xt, t)),
          e.forEach((t) => Xn(r, gt, t));
      });
    ...
    resolveNamedOptions(t, e, i, n = [""]) {
      const o = { $shared: !0 },
        { resolver: s, subPrefixes: a } = Kn(this._resolverCache, t, n);
      let r = s;
      if (
        (function (t, e) {
          const { isScriptable: i, isIndexable: n } = ni(t);
          for (const o of e)
    ...
    createResolver(t, e, i = [""], n) {
      const { resolver: o } = Kn(this._resolverCache, t, i);
  ...
  class oo {
    constructor(t, e) {
      ...
      (this.id = j()),
        ...
        (this.scales = {}),
        (this._plugins = new Fn()),
        (this.$proxies = {}),
        (this._hiddenIndices = {}),
        (this.attached = !1),
        (this._animationsDisabled = void 0),
        (this.$context = void 0),
        (this._doResize = i(() => this.update("resize"), l.resizeDelay || 0)),
        (io[n.id] = n),
        c && h
          ? (a.listen(n, "complete", Jn),
            a.listen(n, "progress", to),
            n._initialize(),
            n.attached && n.update())
          : console.error(
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (
          ...
          (s.type = a),
          (s.indexAxis = o.indexAxis || Wn(a, t.options)),
          (s.order = o.order || 0),
          (s.index = n),
          (s.label = "" + o.label),
    ...
    _updateVisibility(t, e, i) {
      ...
      ht(e)
        ? ((s.data[e].hidden = !i), n.update())
        : (n.setDatasetVisibility(t, i),
  ...
  Object.defineProperties(oo, {
    defaults: { enumerable: ao, value: xt },
    instances: { enumerable: ao, value: io },
    overrides: { enumerable: ao, value: ft },
    registry: { enumerable: ao, value: zn },
    version: { enumerable: ao, value: "3.5.1" },
    getChart: { enumerable: ao, value: no },
    register: {
      enumerable: ao,
      value: (...t) => {
        zn.add(...t), so();
  ...
  function po(t, e, i, n) {
    ...
    const {
      ...
      return (
        ...
        { start: i, end: n, reverse: e, top: o, bottom: s }
      );
    })(t);
    "middle" === o &&
      i &&
  ...
  class bo extends wn {
      ...
      for (let d = e; d < e + i; d++) {
        const e = o.getParsed(d),
          ...
          m = {
            ...
            base: i.base,
            enableBorderRadius:
              !p || go(e._custom) || a === p._top || a === p._bottom,
            x: c ? i.head : g.center,
            y: c ? g.center : i.head,
        ...
        f &&
          (m.options =
            u || o.resolveDataElementOptions(d, t[d].active ? "active" : n)),
          po(m, m.options || t[d].options, p, a),
    ...
    _calculateBarValuePixels(t) {
      ...
      if (
        ((h = e.chart.getDataVisibility(t) ? i.getPixelForValue(f + g) : m),
        (d = h - m),
        Math.abs(d) < s &&
          ((d =
            (function (t, e, i) {
  ...
  class yo extends wn {
        ...
        { circumference: h, rotation: d } = e._getRotationExtents(),
        {
          ...
          if (e < _t) {
            const r = t,
              ...
              u = Math.sin(l),
              f = (t, e, n) =>
                Nt(t, r, l, !0) ? 1 : Math.max(e, e * i, n, n * i),
              g = (t, e, n) =>
                Nt(t, r, l, !0) ? -1 : Math.min(e, e * i, n, n * i),
              p = f(0, c, d),
              m = f(Mt, h, u),
              x = g(bt, c, d),
              b = g(bt + Mt, h, u);
    ...
    updateElements(t, e, i, n) {
      ...
      for (x = e; x < e + i; ++x) {
        ...
        m &&
          (a.options =
            p || o.resolveDataElementOptions(x, i.active ? "active" : n)),
          (b += e),
        ...
        if (t._sorted) {
          ...
          d &&
            (o = Ht(
              Math.min(
                se(r, a.axis, c).lo,
                i ? n : se(e, l, a.getPixelForValue(c)).lo
              ),
              0,
              n - 1
            )),
            (s = u
              ? Ht(
                  Math.max(
                    se(r, a.axis, h).hi + 1,
                    i ? 0 : se(e, l, a.getPixelForValue(h)).hi + 1
                  ),
                  o,
                  n
                ) - o
  ...
  class Lo extends Mn {
    ...
    draw(t) {
      ...
      if (
        ...
        (e.fullCircles = n > _t ? Math.floor(n / _t) : 0),
  ...
  function zo(t, e, i, n) {
    const { points: o, options: s } = e,
      { count: a, start: r, loop: l, ilen: c } = Io(o, i, n),
      h = (function (t) {
        return t.stepped
          ? Jt
  ...
  (Lo.id = "arc"),
    ...
    (Lo.defaultRoutes = { backgroundColor: "backgroundColor" });
  const Vo = "function" == typeof Path2D;
  function Wo(t, e, i, n) {
    Vo && 1 === e.segments.length
      ? (function (t, e, i, n) {
          let o = e._path;
  ...
  class No extends Mn {
    ...
    get segments() {
      return (
        this._segments || (this._segments = Fi(this, this.options.segment))
      );
    }
    first() {
    ...
    interpolate(t, e) {
      const i = this,
        ...
        o = t[e],
        s = i.points,
        a = zi(i, { property: e, start: o, end: o });
      if (!a.length) return;
      const r = [],
        l = (function (t) {
          return t.stepped
  ...
  function Ko(t, e, i = {}) {
    ...
    return { x: t.x + n, y: t.y + o, w: t.w + s, h: t.h + a, radius: t.radius };
  }
  (jo.id = "point"),
    (jo.defaults = {
      borderWidth: 1,
    ...
    beforeElementsUpdate: (t, e, i) => {
      ...
      t.data.datasets.forEach((e, o) => {
        ...
        let { start: h, count: d } = (function (t, e) {
          ...
          return (
            l && (o = Ht(se(e, s.axis, a).lo, 0, i - 1)),
            (n = c ? Ht(se(e, s.axis, r).hi + 1, o, i) - o : i - o),
            { start: o, count: n }
          );
        })(r, l);
            ...
            u = (function (t, e, i, n, o) {
              ...
              for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                ...
                for (u = f = -1, n = b; n < _; n++)
                  (f =
                    0.5 *
                    Math.abs((y - o) * (t[n].y - v) - (y - t[n].x) * (s - v))),
                    f > u && ((u = f), (d = t[n]), (g = n));
                (a[l++] = d), (p = g);
              }
              return (a[l++] = t[c]), a;
  ...
  function ss(t) {
    ...
    l.push(cs({ x: null, y: i.bottom }, o));
    for (let t = 0; t < a.length; t++) {
      const e = a[t];
      for (let t = e.start; t <= e.end; t++) rs(s, r[t], l);
    }
    return new No({ points: s, options: {} });
  }
  ...
  function rs(t, e, i) {
    ...
    for (let o = 0; o < i.length; o++) {
      const s = i[o],
        { first: a, last: r, point: l } = ls(s, e, "x");
      if (!(!l || (a && r)))
        if (a) n.unshift(l);
          ...
          for (const e of c) {
            ...
            for (const t of r)
              a.push({
                source: t,
                target: e,
                start: { [i]: fs(l, n, "start", Math.max) },
                end: { [i]: fs(l, n, "end", Math.min) },
              });
          }
        }
        return a;
      ...
      (function (t, e) {
        ...
        t.save(),
          "x" === l &&
            s !== o &&
            (ds(t, n, a.top),
            ms(t, { line: i, target: n, color: o, scale: r, property: l }),
            t.restore(),
            t.save(),
            ds(t, n, a.bottom)),
          ms(t, { line: i, target: n, color: s, scale: r, property: l }),
          t.restore();
      })(t, {
        line: o,
        target: n,
  ...
  class ys extends Mn {
    ...
    setDimensions() {
      ...
      t.isHorizontal()
        ? ((t.width = t.maxWidth),
          (t.left = t._margins.left),
          (t.right = t.width))
        : ((t.height = t.maxHeight),
          (t.top = t._margins.top),
          (t.bottom = t.height));
    }
    buildLabels() {
      const t = this,
    ...
    fit() {
      ...
      const n = e.labels,
        ...
        { boxWidth: r, itemHeight: l } = _s(n, s);
      let c, h;
      (i.font = o.string),
        t.isHorizontal()
      ...
      return (
        o.legendItems.forEach((t, o) => {
          ...
          o > 0 &&
            ...
            p++,
            (u = f = 0)),
            (l[o] = { left: g, top: f, col: p, width: a, height: n }),
            (u = Math.max(u, a)),
            (f += n + r);
        }),
        (d += u),
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const c of i)
          a !== c.row &&
            ((a = c.row), (l = o(n, t.left + s, t.right - t.lineWidths[a]))),
            (c.top += t.top + e + s),
    ...
    _draw() {
      ...
      t.drawTitle(),
        ...
        (a.lineWidth = 0.5),
        (a.font = d.string);
      const { boxWidth: x, boxHeight: b, itemHeight: _ } = _s(l, g),
        y = t.isHorizontal(),
        ...
        h.setWidth(t.width),
          y
            ? k > 0 &&
              ...
              ((O = m.y += w),
              m.line++,
              (C = m.x = o(r, t.left + f, t.right - n[m.line])))
            : k > 0 &&
              O + w > t.bottom &&
              ((C = m.x = C + i[m.line].width + f),
              m.line++,
              (O = m.y = o(r, t.top + v + f, t.bottom - i[m.line].height)));
        !(function (t, e, i) {
          ...
          (C = s(P, C + x + p, y ? C + D : t.right, e.rtl)),
          (function (t, e, i) {
  ...
  var vs = {
    ...
    _element: ys,
    start(t, e, i) {
      const n = (t.legend = new ys({ ctx: t.ctx, options: i, chart: t }));
  ...
  var Ms = {
    ...
    start(t, e, i) {
      !(function (t, e) {
        const i = new ws({ ctx: t.ctx, options: e, chart: t });
  ...
  var Ss = {
    id: "subtitle",
    start(t, e, i) {
      const n = new ws({ ctx: t.ctx, options: i, chart: t });
  ...
  function Ls(t, e, i) {
    ...
    return { xAlign: e.xAlign || As(t, e, i, n), yAlign: n };
  }
  function Rs(t, e, i, n) {
  ...
  class Fs extends Mn {
      ...
      return (
        J(t, (t) => {
          const e = { before: [], lines: [], after: [] },
            s = zs(n, t);
          Ds(e.before, Cs(s.beforeLabel.call(i, t))),
            Ds(e.lines, s.label.call(i, t)),
            Ds(e.after, Cs(s.afterLabel.call(i, t))),
            o.push(e);
        }),
        o
      );
    ...
    _drawColorBox(t, e, i, n, o) {
      ...
      if (o.usePointStyle) {
        ...
        Object.values(s).some((t) => 0 !== t)
          ? (t.beginPath(),
            (t.fillStyle = o.multiKeyBackground),
            ne(t, { x: e, y: g, w: c, h: l, radius: s }),
            t.fill(),
            t.stroke(),
            (t.fillStyle = a.backgroundColor),
            t.beginPath(),
            ne(t, { x: i, y: g + 1, w: c - 2, h: l - 2, radius: s }),
            t.fill())
          : ((t.fillStyle = o.multiKeyBackground),
            t.fillRect(e, g, c, l),
    ...
    draw(t) {
      ...
      i.enabled &&
        ...
        Ai(t, i.textDirection),
        (s.y += a.top),
        e.drawTitle(s, t, i),
        e.drawBody(s, t, i),
        e.drawFooter(s, t, i),
        Li(t, i.textDirection),
        t.restore());
    }
    getActiveElements() {
      return this._active || [];
  ...
  var Bs = {
      ...
      positioners: Ps,
      afterInit(t, e, i) {
        i && (t.tooltip = new Fs({ _chart: t, options: i }));
      },
      beforeUpdate(t, e, i) {
  ...
  function Hs(t, e, { horizontal: i, minRotation: n }) {
    const o = Et(n),
  ...
  class js extends En {
    ...
    handleTickRangeOptions() {
      ...
      if (o === s) {
        let t = 1;
        (s >= Number.MAX_SAFE_INTEGER || o <= Number.MIN_SAFE_INTEGER) &&
          (t = Math.abs(0.05 * s)),
          r(s + t),
          e || a(o - t);
      }
      ...
      const o = (function (t, e) {
        ...
        (M = Math.ceil(p / k) - Math.floor(g / k)),
          ...
          "ticks" === n
            ...
            : ((v = g), (w = p)),
          m && x && o && Lt((a - s) / o, k / 1e3)
            ? ((M = Math.round(Math.min((a - s) / k, c))),
              (k = (a - s) / M),
              (v = s),
              (w = a))
            : b
            ? ((v = m ? s : v), (w = x ? a : w), (M = l - 1), (k = (w - v) / M))
            : ((M = (w - v) / k),
              (M = At(M, Math.round(M), k / 1e3)
                ? Math.round(M)
                : Math.ceil(M)));
        ...
        for (
          ...
          (d && v !== s
            ? (i.push({ value: s }),
              v < s && P++,
              At(Math.round((v + P * k) * y) / y, s, Hs(s, _, t)) && P++)
            : v < s && P++);
          P < M;
          ++P
        )
        ...
        return (
          x && d && w !== a
            ? At(i[i.length - 1].value, a, Hs(a, _, t))
  ...
  ($s.id = "linear"),
    ($s.defaults = { ticks: { callback: Sn.formatters.numeric } });
  class Us extends En {
    constructor(t) {
      super(t),
        (this.start = void 0),
    ...
    buildTicks() {
      const t = this,
        ...
        i = (function (t, e) {
          ...
          do {
            o.push({ value: s, major: Ys(s) }),
              ++r,
              10 === r && ((r = 1), ++a, (l = a >= 0 ? 1 : l)),
              (s = Math.round(r * Math.pow(10, a) * l) / l);
          } while (a < i || (a === i && r < n));
          const c = q(t.max, s);
          return o.push({ value: c, major: Ys(s) }), o;
    ...
    for (let c = 0; c < s; c++) {
      ...
      const h = t.getPointPosition(c, t.drawingArea + o[c]),
        ...
        u =
          ((a = t.ctx),
          (r = d),
          (l = Y((l = t._pointLabels[c])) ? l : [l]),
          { w: Ut(a, r.string, l), h: l.length * r.lineHeight });
      n[c] = u;
  ...
  (Us.id = "logarithmic"),
    (Us.defaults = {
      ticks: { callback: Sn.formatters.logarithmic, major: { enabled: !0 } },
    });
  class ea extends js {
    constructor(t) {
      super(t),
    ...
    generateTickLabels(t) {
      const e = this;
      js.prototype.generateTickLabels.call(e, t),
  ...
  (ea.id = "radialLinear"),
    (ea.defaults = {
      ...
      grid: { circular: !1 },
      startAngle: 0,
      ticks: { showLabelBackdrop: !0, callback: Sn.formatters.numeric },
      pointLabels: {
    ...
    (ea.descriptors = { angleLines: { _fallback: "grid" } });
  const ia = {
  ...
  class ca extends En {
    ...
    buildTicks() {
      ...
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip
            ? aa(i.minUnit, t.min, t.max, t._getLabelCapacity(s))
            : (function (t, e, i, n, o) {
                for (let s = na.length - 1; s >= na.indexOf(i); s--) {
                  const i = na[s];
                  if (ia[i].common && t._adapter.diff(o, n, i) >= e - 1)
                    return i;
                }
    ...
    _generate() {
      ...
      return (
        (d !== n && "ticks" !== o.bounds && 1 !== u) || ra(h, d, g),
        Object.keys(h)
          .sort((t, e) => t - e)
          .map((t) => +t)
      );
  ...
  function ha(t, e, i) {
    let n,
      ...
      l = t.length - 1;
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = se(t, "pos", e)),
        ({ pos: n, time: s } = t[r]),
        ({ pos: o, time: a } = t[l]))
      : (e >= t[r].time &&
          e <= t[l].time &&
          ({ lo: r, hi: l } = se(t, "time", e)),
        ({ time: n, pos: s } = t[r]),
        ({ time: o, pos: a } = t[l]));
    const c = o - n;
  ...
  class da extends ca {
    ...
    initOffsets() {
      ...
      (t._minPos = ha(i, t.min)),
        (t._tableRange = ha(i, t.max) - t._minPos),
        super.initOffsets(e);
    }
    buildLookupTable(t) {
  ...
  return (
    oo.register(Po, ua, Zo, Vs),
    (oo.helpers = { ...Ni }),
    (oo._adapters = co),
    (oo.Animation = ln),
    (oo.Animations = hn),
    (oo.animator = a),
    (oo.controllers = zn.controllers.items),
    (oo.DatasetController = wn),
    (oo.Element = Mn),
    (oo.elements = Zo),
    (oo.Interaction = Ae),
    (oo.layouts = ti),
    ...
    (oo.Scale = En),
    (oo.Ticks = Sn),
    Object.assign(oo, Po, ua, Zo, Vs, sn),
    (oo.Chart = oo),
    "undefined" != typeof window && (window.Chart = oo),
    oo
  );
});
